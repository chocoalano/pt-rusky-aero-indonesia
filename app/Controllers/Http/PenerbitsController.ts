...
import RepoModels from '../Repositories/RepoModels/Penerbit/RepoModels';
import PenerbitValidator from 'App/Validators/PenerbitValidator';
...
export default class PenerbitsController {
    ...
    public async store({ request, response }: HttpContextContract) {
        const payload = await request.validate(PenerbitValidator)
