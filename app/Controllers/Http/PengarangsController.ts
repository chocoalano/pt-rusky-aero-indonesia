...
import RepoModels from '../Repositories/RepoModels/Pengarang/RepoModels';
import PengarangValidator from 'App/Validators/PengarangValidator';

export default class PengarangsController {
    ...
    public async store({ request, response }: HttpContextContract) {
        const payload = await request.validate(PengarangValidator)
